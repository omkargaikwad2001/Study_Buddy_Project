	...
	<div class="wrapper">
		...
		<div class="signinmain">
			...
			<div class="signincontainer">
				...
				<div class="signleft">
					<img
						src="https://img.freepik.com/free-vector/mobile-login-concept-illustration_114360-83.jpg?w=740&t=st=1709134298~exp=1709134898~hmac=51ddcda8203504b3b7f093cb459de6a0c6d67dfa8df487e61e89b951e9fcc988"
						alt="signinimg">
				</div>
				...
				<div class="signright">
					...
					<form action="validate-student" method="POST">
						...
						<label for="mail">Email Address:</label> <input type="email"
							name="mail" id="mail" required> <label for="pass">Password:</label>
