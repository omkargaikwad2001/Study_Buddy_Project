...
.maincontainer {
	...
	padding-top: 5rem;
	display: flex;
	background-image: linear-gradient(to top, white, rgb(158, 187, 233),
		rgba(174, 210, 248, 0.079), white);
}
...
.rightwrapper {
	...
	margin-left: 5rem;
	background-image: linear-gradient(to bottom, rgb(233, 237, 245),
		rgba(207, 218, 230, 0.437));
}
			...
			<div class="navdiv">
				...
				<div class="links">
					...
					<ul>
						...
						<li><a
							href="http://localhost:8879/sm/student-coursce#courses">Courses</a></li>
						<li><a
							href="http://localhost:8879/sm/student-coursce#aboutus">About
								Us</a></li>
						<li><a href="Doubt-post-section">Ask Doubts</a></li>
						<li><a
							href="http://localhost:8879/sm/student-coursce#contactus">Contact
								Us</a></li>
					</ul>
			...
			<div class="maincontainer">
				...
				<div class="mainright">
					...
					<div class="rightwrapper">
						...
						<div class="price">
							&#x20B9;
							<%=ac.getPrice()%><span class="strickprice"> &#x20B9;3000</span>
						</div>
						<%
						if (obj == null) {
						%>
						<a
							href="http://localhost:8879/sm/login-sm?msg=please login for buy">
							<%
							}
							...
							<div class="coursecontains">
								...
								<div class="disc">
									<div class="iconanddisc">
										<i class="fa-solid fa-play"></i>
										<p>No Prerequisite Required</p>
									</div>
									<div class="iconanddisc">
										<i class="fa-solid fa-play"></i>
										<p>150 Hours On Demand Video</p>
									</div>
									<div class="iconanddisc">
										<i class="fa-solid fa-play"></i>
										<p>Learn Beginner to Advanced</p>
									</div>
									<div class="iconanddisc">
										<i class="fa-solid fa-play"></i>
					...
					<div class="learndiv">
						...
						<div class="learndivleft">
							...
							<div class="learncontent">
								...
								<div class="icondiv">
									<i class="fa-solid fa-check"></i>Introduction to the
									programming
								</div>
								<div class="icondiv">
									<i class="fa-solid fa-check"></i>Basic Structure of the Program
								</div>
								<div class="icondiv">
									<i class="fa-solid fa-check"></i>Data Types and how to use
								</div>
								<div class="icondiv">
									<i class="fa-solid fa-check"></i>Operators
								</div>
								<div class="icondiv">
									<i class="fa-solid fa-check"></i>Control Flow
								</div>
					...
					<div class="learndiv">
						...
						<div class="learndivright">
							...
							<div class="learncontent">
								...
								<div class="icondiv">Online Recorded Lectures</div>
								<!-- 
                                <div class="icondiv">
                                    C Programming </div> -->
								<div class="icondiv">50</div>
								<div class="icondiv">Yes</div>
								<div class="icondiv">1.5 Years</div>
					...
					<div class="coursecontainer">
						...
						<div class="Instructorwrapper">
							...
							<div class="instructorimg">
								...
								<img
									src="https://img.freepik.com/free-vector/interview-concept-illustration_114360-1678.jpg?w=740&t=st=1709135653~exp=1709136253~hmac=19f7fb7c7af59c4e342b16ad8fa1ea67c6e4c20984097a979597dd06452629cd"
									alt="instructorimg">
				...
				<div class="coursewrapper" id="faq">
					...
					<div class="coursecontainer">
						...
						<div class="faq">
							...
							<div class="pannel">
								<p>A programming language is a formal language comprising a
									set of instructions that produce various kinds of output. These
									instructions are designed to be executed by a computer,
									typically to perform tasks or solve problems. Programming
									languages allow developers to communicate with computers,
									instructing them to perform specific operations, manipulate
									data, and control the flow of execution.</p>
							</div>
						</div>

						<div class="faq">
							<button class="accordion">
								How do I sign up for an account? <i
									class="fa-solid fa-chevron-down"></i>
							</button>
							<div class="pannel">
								<p>Click on signup button to create account</p>
							</div>
						</div>

						<div class="faq">
							<button class="accordion">
								How do I log in to my account? <i
									class="fa-solid fa-chevron-down"></i>
							</button>
							<div class="pannel">
						...
						<div class="faq">
							<button class="accordion">
								What courses do you offer? <i class="fa-solid fa-chevron-down"></i>
							</button>
							<div class="pannel">
								<p>We are offering fronted, backened, full stack and soft
									skill courses</p>
							</div>
						</div>
						...
						<div class="faq">
							<button class="accordion">
								How do I enroll in a course? <i class="fa-solid fa-chevron-down"></i>
							</button>
							<div class="pannel">
								<p>First create a account and then enroll course</p>
							</div>
						</div>

						<div class="faq">
							<button class="accordion">
								Is there a cost for courses? <i class="fa-solid fa-chevron-down"></i>
							</button>
							<div class="pannel">
								<p>Yes every courses have some cost</p>
							</div>
						</div>

						<div class="faq">
							<button class="accordion">
								What is the duration of courses.? <i
									class="fa-solid fa-chevron-down"></i>
							</button>
							<div class="pannel">
								<p>More then 150+ hours</p>
							</div>
						</div>

						<div class="faq">
							<button class="accordion">
								How can I contact support for assistance? <i
									class="fa-solid fa-chevron-down"></i>
							</button>
							<div class="pannel">
								<p>Throw Contact us or email us: support@studdybuddy.com</p>
							</div>
						</div>
						...
						<div class="footcontainer">
							...
							<div class="t2">
								...
								<ul>
									...
									<li><a href="http://127.0.0.1:5501/index.html#aboutus">About
											Us</a></li>
									<li><a href="http://127.0.0.1:5501/index.html#contactus">Contact
											Us</a></li>
								</ul>
							</div>
