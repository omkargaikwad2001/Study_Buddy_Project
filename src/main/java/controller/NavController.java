...
//	System.out.println(object);
	...
	public String updateCourceByAdmin(AllCourses object, BindingResult br,
			jakarta.servlet.http.HttpServletRequest request, HttpSession session, @RequestParam("cName") String cName,
			@RequestParam("cDescription") String cDescription, @RequestParam("cPost") String cPost,
			@RequestParam("cInstructor") String cInstructor, @RequestParam("cExperience") String cExperience,
			@RequestParam("instructorInfo") String instructorInfo, @RequestParam("img") String img,
